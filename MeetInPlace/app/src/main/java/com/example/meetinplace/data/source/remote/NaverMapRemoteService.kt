    ...
    private val mOkHttpClient = OkHttpClient().newBuilder()
        ...
        .addInterceptor { chain ->
            val request = chain.request().newBuilder()
                ...
                .addHeader("X-NCP-APIGW-API-KEY-ID", MyApplication.NAVER_API_ID)
                .addHeader("X-NCP-APIGW-API-KEY", MyApplication.NAVER_API_KEY).build()
